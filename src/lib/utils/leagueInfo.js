...
export const homepageText = `
  <p>Founded in 2018, the Tigers Dynasty League began as keeper league amongst a small group of friends on 3rd of September, when we held our first live draft. We are slowly working towards converting the league into a full-fledged dynasty league. Each year, the managers compete to win the Dynasty Bowl and avoid the ever-humiliating Toilet Bowl.</p>
<p> </p>
<p>Some managers drafted and built immediate win-now teams, while others began the slow process of building a juggernaut dynasty team. A portion of the league prioritized youth and draft picks, the rest gravitated towards the steadfast value of veterans.</p>
<p> </p>
...
export const managers = [
     ...
     },
    {
       ...
       "mode": "Rebuild", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
         name: "Žiga Hanžič", // Can be anything (usually your rival's name)
         link: 4, // manager array number within this array, or null to link back to all managers page
         image: "/managers/hanzo.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
